...
const DEFAULT_COLUMNS = {
  employeeList: [
    ...
    { key: 'mobile', order: 2, width: 140, pinned: null },
    { key: 'department', order: 3, width: 150, pinned: null },
    { key: 'designation', order: 4, width: 150, pinned: null },
    { key: 'role', order: 5, width: 120, pinned: null },
    { key: 'joiningDate', order: 6, width: 130, pinned: null },
    { key: 'dateOfBirth', order: 7, width: 130, pinned: null },
    { key: 'endingDate', order: 8, width: 130, pinned: null },
    { key: 'salary', order: 9, width: 120, pinned: null },
    { key: 'reportingManager', order: 10, width: 160, pinned: null },
    { key: 'managerDepartments', order: 11, width: 180, pinned: null },
    { key: 'status', order: 12, width: 100, pinned: null },
    { key: 'lastLogin', order: 13, width: 140, pinned: null },
  ],
  attendanceToday: [
    { key: 'name', order: 0, width: 200, pinned: null },
...
const COLUMN_PERMISSIONS = {
  employeeList: {
    ...
    dateOfBirth: [PERMISSIONS.USERS_READ],
    endingDate: [PERMISSIONS.USERS_READ],
    salary: [PERMISSIONS.SALARY_READ, PERMISSIONS.SALARY_READ_TEAM],
    reportingManager: [PERMISSIONS.USERS_READ],
    managerDepartments: [PERMISSIONS.USERS_READ],
    status: [PERMISSIONS.USERS_READ],
    lastLogin: [PERMISSIONS.USERS_READ],
  },
  attendanceToday: {
