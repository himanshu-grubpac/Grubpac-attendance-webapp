...
const DEFAULT_COLUMNS = {
  employeeList: [
    ...
    { key: 'role', order: 6, width: 120, pinned: null },
    { key: 'joiningDate', order: 7, width: 130, pinned: null },
    { key: 'dateOfBirth', order: 8, width: 130, pinned: null },
    { key: 'endingDate', order: 9, width: 130, pinned: null },
    { key: 'salary', order: 10, width: 120, pinned: null },
...
const COLUMN_PERMISSIONS = {
  employeeList: {
    ...
    department: [PERMISSIONS.EMPLOYEES_EMPLOYMENT_R],
