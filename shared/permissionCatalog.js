...
export const PERMISSION_CATALOG = [
  ...
  row({ row: 61, portal: 'Employee', navGroup: 'Overview', page: 'Dashboard', resource: 'Team attendance today', read: 'emp.team_today.r', admin: 'N', hr: 'Y', reportingManager: 'Y', employee: 'R', notes: 'Team-scoped: same-RM peers plus own RM, never self' }),
